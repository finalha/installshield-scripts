...
set "CurrentDir=%~dp0"
set "LocalPort=%~3"
set "rabbitMqCertCaPath=%~4"
set "rabbitMqCertPath=%~5"
set "rabbitMqPrivateKey=%~6"
...
cscript.exe "%CurrentDir%\replacefiletext.vbs" "%DestPath%\rabbitmq.config" "%%%% {ssl_options,\[{cacertfile," "{ssl_options,[{cacertfile," "%DestPath%\rabbitmq.config"
cscript.exe "%CurrentDir%\replacefiletext.vbs" "%DestPath%\rabbitmq.config" "C\:/cacert.pem" "%rabbitMqCertCaPath%" "%DestPath%\rabbitmq.config"
